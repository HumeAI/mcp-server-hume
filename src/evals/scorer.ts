    ...
    tools: [
      {
        name: "score",
        description:
          "Evaluate an AI agent's performance in a chat transcript. Provide a `null` score if there are no examples of the agent fulfilling or failing to fulfill a criterion. Provide a 1.0 score if every example shows the agent fulfilling the criterion perfectly. Provide a score no higher than 5.0 if there is a single example of the agent failing to fulfill the criterion. Provide a low score between 0.0 and 3.0 if there are several examples of the agent failing to fulfill the criterion.",
        input_schema: {
          type: "object",
              ...
              name,
              {
                ...
                properties: {
                  ...
                  reason: {
                    type: "string",
                    description:
                      "Summarize what the agent did that caused it to receive the score",
                  },
                  examples: {
                    type: "string",
                    description:
